...
public class StoreServer {
    static String dbfile = "/Users/ligao//Desktop/COMP3700/Project/Project2_2/store.db";
        ...
        try {
            ...
            while (true) {
                ...
                if (msg.code == MessageModel.PUT_PURCHASE) {
                    PurchaseModel c = gson.fromJson(msg.data, PurchaseModel.class);
                    System.out.println("PUT command with Purchase = " + c);
                    int res = adapter.savePurchase(c);
